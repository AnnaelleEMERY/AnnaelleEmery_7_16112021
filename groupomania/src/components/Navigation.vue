<template>
  <div id="nav">
    ...
    <b-navbar class="nav bg-primary-color" type="dark" toggleable="md">
      <div class="logo"></div>
        ...
        <b-collapse id="nav-collapse" class="nav-collapse" is-nav>
          <b-navbar-nav class="item-group">
            ...
            <template class="template-items" v-else>
                <img class="groupomania-logo" src="@/assets/groupomania_logos/icon-left-font-monochrome-white.png"
                    alt="Logo blanc groupomania" width="200"/>
              <!-- Affiché si l'utilisateur n'est pas connu -->
              <b-nav-item class="item text-center text-white-color" @click="showRegister = true">
                <b-icon-person-plus-fill class="icone" />
                <p class="texte">Inscription</p>
              </b-nav-item>
              <b-nav-item class="item text-center text-white-color" @click="showLogin = true">
...
#nav {
  ...
  margin: 0;
  .modal-overlay{
    background-color: rgba(21, 21, 22, 0.576);
    top: 0;
    right: 0;
    bottom: 0;
    left: 0;
